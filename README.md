...
## Contrato canônico (Fase 1)

Foi iniciado um contrato canônico aditivo para parsers de fatura, sem quebrar o payload legado.

- Documento: `docs/invoice-parser-contract-v1.md`
- Parsers com envelope v1 ativo:
  - Sicredi (`parse_sicredi`)
  - Santander (`parse_santander`)
  - Bradesco Fatura Mensal v1 (`parse_bradesco_fatura_mensal_v1`)
  - Itaú Personnalité (`parse_itau_personnalite`)
  - Itaú LATAM Pass (`parse_itau_latam_pass`)
- Campos legados preservados: `bank`, `dueDate`, `total`, `transactions`
- Campos novos (aditivos): `parserContractVersion`, `summary`, `reconciliation`, `diagnostics`
