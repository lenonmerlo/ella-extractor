...
def test_itau_personnalite_contract_v1_additive_fields_present_and_consistent() -> None:
    fixture_path = Path(__file__).resolve().parent / "fixtures" / "itau_personnalite_reference.txt"
    assert fixture_path.exists(), "Fixture itau_personnalite_reference.txt não encontrado"
